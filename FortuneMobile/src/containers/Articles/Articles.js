...
import { articlesListRequested, getCustomerBalanceRequested, paymentRequested } from '../../modules/Articles/actions';
import { getErrorSelector, getArticlesDataSelector, getCustomerBalanceSelector, getLoadingSelector, getPaymentDataSelector } 
...
const mapDispatchToProps = dispatch => ({
  ...
  paymentRequested: (fosId, customerId, payAmount) => dispatch(paymentRequested(fosId, customerId, payAmount)),
});
